...
plot "~/Desktop/research/quick_plots/dist2.txt"   using 1:2 with lines title 'both', '' using 1:3with lines title 'theoretical'
...
plot "~/Desktop/research/quick_plots/dist3.txt"   using 1:2 with lines title 'calc', '' using 1:3 with lines title 'theoretical'
